...
(function () {
  ...
  const T = {
    ...
    'بيولوجيا الحيوان': 'Animal Biology',
    ...
    'تقييمات الطلبة': 'Student Ratings',
    'تصفّح تقييمات المواد': 'Browse course ratings',
    '🔍 ابحث عن المادة اللي تبي تقيّمها...': '🔍 Search for the course you want to rate...',
    'رأيك بالمادة (اختياري) — صعوبة، حمل المادة، نصايح...': 'Your thoughts on the course (optional) — difficulty, workload, tips...',
    '🔍 فلترة حسب اسم أو رمز المادة...': '🔍 Filter by course name or code...',
    'لا توجد تقييمات منشورة بعد.': 'No published ratings yet.',
    'الأخبار': 'News',
    'الإعلانات': 'Announcements',
    'الوضع المفضل': 'Favorites',
